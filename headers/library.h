...
struct Color {
	...
	unsigned int b; // Blue
	unsigned int a; // Transparency
	Color(const unsigned int R = NULL, const unsigned int G = NULL, const unsigned int B = NULL, const unsigned int A = 255) : r(R), g(G), b(B), a(A) {}
	~Color() {}
	SDL_Color toSDL_Color(void) const {
		SDL_Color color;
		color.a = a;
		color.r = r;
		color.g = g;
